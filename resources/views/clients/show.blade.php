...
@php
    $allClientsData = [
        'exxonmobil' => [
            ...
            'logo' => '<svg width="220" height="60" viewBox="0 0 180 50" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M15 10H30L38 24L46 10H61L48 29L62 48H47L38 33L29 48H14L28 29L15 10Z" fill="#EE2722"/><path d="M60 10H75L83 24L91 10H106L93 29L107 48H92L83 33L74 48H59L73 29L60 10Z" fill="#EE2722"/><text x="112" y="38" font-family="Inter, sans-serif" font-weight="900" font-size="24" fill="#EE2722">Mobil</text></svg>',
            'headline' => 'Parceria Estratégica de Comunicação & Atração de Talentos',
            'desc' => 'Desenvolvemos formatos de conteúdos audiovisuais e campanhas de reciclagem avançada para a ExxonMobil, humanizando conceitos técnicos complexos para o público global e stakeholders.',
            ...
            'works' => [
                [
                    ...
                    'img' => 'https://images.unsplash.com/photo-1581092918056-0c4c3acd3789?w=700&auto=format&fit=crop&q=80',
                ],
                [
                    'slug' => 'exxtend',
                    'client' => 'ExxonMobil',
                    ...
                    'img' => 'https://images.unsplash.com/photo-1532996122724-e3c354a0b15b?w=700&auto=format&fit=crop&q=80',
                ],
            ]
        ],
        'tullow-oil' => [
            'name' => 'Tullow Oil',
            'sector' => 'Petróleo & Gás',
            'logo' => '<svg width="200" height="60" viewBox="0 0 180 50" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="25" cy="25" r="16" fill="#005A36"/><path d="M25 15V35M15 25H35" stroke="#FFFFFF" stroke-width="4"/><text x="52" y="34" font-family="Inter, sans-serif" font-weight="900" font-size="22" fill="#005A36" letter-spacing="1">TULLOW</text></svg>',
            'headline' => 'Comunicação Comunitária e Envolvimento Local',
            'desc' => 'Criámos publicações ilustradas e materiais estratégicos que aproximam as comunidades locais da cadeia de valor energética da Tullow Oil.',
            ...
            'works' => [
                [
                    ...
                    'desc' => 'Publicação ilustrada que aproxima comunidades locais da cadeia de valor do setor energético.',
                    'img' => 'https://images.unsplash.com/photo-1590859808308-3d2d9c515b1a?w=700&auto=format&fit=crop&q=80',
                ],
            ]
        ],
        'perenco' => [
            ...
            'logo' => '<svg width="200" height="60" viewBox="0 0 180 50" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="10" y="12" width="26" height="26" fill="#002D62"/><path d="M18 20H28M18 25H28M18 30H24" stroke="#FFFFFF" stroke-width="2.5"/><text x="45" y="34" font-family="Inter, sans-serif" font-weight="900" font-size="22" fill="#002D62" letter-spacing="1">PERENCO</text></svg>',
            'headline' => 'Campanhas anuais de Sustentabilidade & Transição Energética',
            'desc' => 'Produção de campanhas de elevado impacto visual documentando iniciativas de descarbonização e captura de carbono.',
            ...
            'works' => [
                [
                    ...
                    'img' => 'https://images.unsplash.com/photo-1497435334941-8c899ee9e8e9?w=700&auto=format&fit=crop&q=80',
                ],
            ]
        ],
        'sonangol' => [
            ...
            'logo' => '<svg width="200" height="60" viewBox="0 0 180 50" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M22 10C15 18 15 28 22 36C29 28 29 18 22 10Z" fill="#E30613"/><path d="M22 16C18 22 18 28 22 32C26 28 26 22 22 16Z" fill="#FFC72C"/><text x="36" y="34" font-family="Inter, sans-serif" font-weight="900" font-size="22" fill="#141414">SONANGOL</text></svg>',
            'headline' => 'Comunicação Institucional da Marca Líder de Angola',
            'desc' => 'Planeamento estratégico de comunicação e produção de conteúdos para a celebração de marcos históricos corporativos.',
    ...
    $cSector = $clientObj ? ($clientObj->sector ?? 'Parceiro Estratégico') : ($clientArr['sector'] ?? 'Parceiro Estratégico');
    $cHeadline = $clientObj ? ($clientObj->headline ?? 'Estratégias de Publicidade & Marketing 360°') : ($clientArr['headline'] ?? 'Estratégias de Publicidade & Marketing 360°');
    $cDesc = $clientObj ? ($clientObj->description ?? 'Projetos desenvolvidos pela Xamariz para fortalecer a liderança e reputação no mercado.') : ($clientArr['desc'] ?? ($clientArr['description'] ?? 'Projetos desenvolvidos pela Xamariz para fortalecer a liderança e reputação no mercado.'));
    $cServices = $clientObj ? ($clientObj->services_provided ?? 'Estratégia, Branding, Audiovisual & Marketing 360°') : ($clientArr['services_provided'] ?? 'Estratégia, Branding, Audiovisual & Marketing 360°');

    $cLogoRaw = $clientObj ? $clientObj->logo_path : ($clientArr['logo'] ?? ($clientArr['logo_path'] ?? ''));
    $cLogoUrl = $cLogoRaw ? (Str::startsWith($cLogoRaw, ['http://', 'https://']) ? $cLogoRaw : asset(ltrim($cLogoRaw, '/'))) : null;
...
@section('title', $cName . ' • Trabalhos & Projetos | Xamariz')
@section('description', 'Explore os projetos de publicidade, branding e marketing 360° desenvolvidos pela Xamariz para ' . $cName . '.')
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div class="lg:col-span-4 reveal delay-100">
                <div class="p-8 bg-gray-50 border border-gray-200 rounded-none space-y-4">
                    <p class="font-sans text-xs font-bold uppercase tracking-widest text-gray-500">RESUMO DA PARCERIA</p>
                    <div>
    ...
    <div class="container-myriad">
        ...
        <div class="reveal flex items-center justify-between mb-12">
            <div>
                <div class="flex items-center gap-2 mb-2">
                    ...
                    <span class="font-sans text-xs font-bold uppercase tracking-widest text-gray-700">PORTFÓLIO DE PROJETOS</span>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @foreach ($cWorks as $work)
                    @php
                        ...
                        $wClientName = is_object($work) && $work->client ? $work->client->name : (is_array($work) ? ($work['client'] ?? $cName) : $cName);
                        $wDesc = is_object($work) ? ($work->summary ?? $work->description) : ($work['desc'] ?? '');
                        $wCover = is_object($work) ? $work->cover_image : ($work['img'] ?? '');
                        $wImg = $wCover ? (Str::startsWith($wCover, ['http://', 'https://']) ? $wCover : asset(ltrim($wCover, '/'))) : 'https://images.unsplash.com/photo-1581092918056-0c4c3acd3789?w=700&auto=format&fit=crop&q=80';
                    @endphp
        ...
        @else
            <div class="py-12 text-center bg-white border border-gray-200">
                <p class="font-sans text-gray-500 text-base">Nenhum projeto específico associado a este cliente de momento.</p>
            </div>
        @endif
...
<section class="py-24 bg-[var(--color-brand-dark)] text-white">
    <div class="container-myriad text-center reveal">
        <div class="inline-flex items-center gap-2 mb-4">
            <span class="w-2.5 h-2.5 rounded-full bg-[var(--color-brand-accent)] inline-block"></span>
            <span class="font-sans text-xs font-bold uppercase tracking-widest text-gray-400">DESENVOLVA A SUA CAMPANHA</span>
        </div>
        <h2 class="font-sans text-3xl sm:text-5xl font-normal text-white mb-6 tracking-tight">
            Procura resultados semelhantes para a sua empresa?
        </h2>
        <p class="font-sans text-gray-400 text-lg mb-10 max-w-xl mx-auto leading-relaxed">
            Fale com a nossa equipa de especialistas e descubra como o Marketing 360° da Xamariz pode impulsionar o seu negócio.
        </p>
